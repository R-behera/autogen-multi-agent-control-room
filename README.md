...
# AutoGen Multi-Agent Control Room

![Demo Screenshot](demo/screenshot.png)

## Overview
Package multi-agent workflows into an operator-first control room with handoff traces, review gates, and auditable decisions.
...
## Project Profile
- Domain: Multi-Agent Operations AI
- Project type: `llm`
- Tags: autogen, multi-agent, llm, ops
